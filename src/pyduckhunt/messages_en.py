...
EN = {
    ...
    '{0} util.': '{0} uses',
    '{0} {1} de pain sur {2}{3}': '{0} {1} of bread on {2}{3}',
    ...
    ' | Mun. : {0}/{1} | Charg. : {2}': ' | Ammo: {0}/{1} | Mags: {2}',
    ' | Mun. : ?/? | Charg. : ?/?': ' | Ammo: ?/? | Mags: ?/?',
    " Ton achat t'a fait repasser au niveau {0} ({1}).": ' Your purchase dropped you back to level {0} ({1}).',
    ' [recyclé]': ' [recycled]',
    'Inf.': 'Inf.',
    'une balle': 'a bullet',
    'une flèche': 'an arrow',
    'un carreau': 'a bolt',
    " et tu l'insères dans ton arme": ' and load it into your weapon',
    ' et tu la charges dans ton arme': ' and load it into your weapon',
    "{0} > Tu achètes {1} en échange de {2} points d'xp{3}.{4}": '{0} > You buy {1} for {2} xp{3}.{4}',
    "{0} > Tu ajoutes un chargeur à ta réserve en échange de {1} points d'xp.{2}": '{0} > You add a magazine to your reserve for {1} xp.{2}',
    "{0} > Tu changes le type de tes munitions en munitions AP (dégâts x2 pendant 24h) en échange de {1} points d'xp.{2}": '{0} > You switch to AP ammunition (x2 damage for 24h) for {1} xp.{2}',
    "{0} > Tu changes le type de tes munitions en munitions explosives (dégâts x3 pendant 24h) en échange de {1} points d'xp.{2}": '{0} > You switch to explosive ammunition (x3 damage for 24h) for {1} xp.{2}',
    "{0} > Tu rachètes l'arme qui t'avait été confisquée en échange de {1} points d'xp.{2}": '{0} > You buy back your confiscated weapon for {1} xp.{2}',
    "{0} > Tu graisses ton arme en échange de {1} points d'xp. Le risque d'enrayage est réduit de moitié et la graisse protège une fois contre un jet de sable pendant 24h.{2}": '{0} > You grease your weapon for {1} xp. Jam risk is halved and the grease blocks one sand attack for 24h.{2}',
    "{0} > Tu ajoutes un détecteur infrarouge à ton arme en échange de {1} points d'xp. La gâchette sera bloquée en l'absence de canard pendant 24h, pour 6 utilisations.{2}": '{0} > You add an infrared detector to your weapon for {1} xp. The trigger will lock when no duck is present for 24h, up to 6 uses.{2}',
    "{0} > Tu ajoutes un silencieux à ton arme en échange de {1} points d'xp. Tes tirs ne risquent plus d'effrayer les canards pendant 24h.{2}": '{0} > You add a suppressor to your weapon for {1} xp. Your shots cannot frighten ducks for 24h.{2}',
    "{0} > Tu achètes des lunettes de soleil en échange de {1} points d'xp. Tu es protégé contre l'éblouissement pendant 24h et en plus, c'est la classe !{2}": '{0} > You buy sunglasses for {1} xp. You are protected from glare for 24h, and they look great!{2}',
    "{0} > Tu fais sécher tes vêtements en échange de {1} points d'xp.{2}": '{0} > You have your clothes dried for {1} xp.{2}',
    "{0} > Tu achètes un goupillon et remets ton arme en état en échange de {1} points d'xp.{2}": '{0} > You buy a bore brush and restore your weapon for {1} xp.{2}',
    "{0} > Tu éblouis {1} avec un miroir en échange de {2} points d'xp.{3}{4}": '{0} > You dazzle {1} with a mirror for {2} xp.{3}{4}',
    "{0} > Tu jettes du sable dans l'arme de {1} en échange de {2} points d'xp.{3}{4}": "{0} > You throw sand into {1}'s weapon for {2} xp.{3}{4}",
    "{0} > Tu jettes un seau d'eau sur {1} en échange de {2} points d'xp.{3}{4}": '{0} > You throw a bucket of water at {1} for {2} xp.{3}{4}',
    "{0} > Tu sabotes l'arme de {1} en échange de {2} points d'xp. Elle explosera lors de son prochain tir.{3}": "{0} > You sabotage {1}'s weapon for {2} xp. It will explode on their next shot.{3}",
    "{0} > Tu souscris une assurance-vie en échange de {1} points d'xp. Pendant 1 semaine, ton prochain accident te rapportera trois fois le niveau du tireur.{2}": '{0} > You buy life insurance for {1} xp. For one week, your next accident will award three times the shooter level.{2}',
    "{0} > Tu souscris une assurance responsabilité civile en échange de {1} points d'xp. Les pénalités d'accident sont divisées par trois pendant 2 jours.{2}": '{0} > You buy liability insurance for {1} xp. Accident penalties are divided by three for 2 days.{2}',
    "{0} > Tu achètes un morceau de pain en échange de {1} points d'xp, augmentant ainsi les chances d'attirer des canards pendant 1h et retardant leur départ. Il y a actuellement {2} {3} de pain sur {4}.{5}": '{0} > You buy a piece of bread for {1} xp, increasing the chance of attracting ducks for 1h and delaying their departure. There are currently {2} {3} of bread on {4}.{5}',
    "{0} > Tu achètes un détecteur de canards en échange de {1} points d'xp. Tu seras averti par une notice lors de l'envol du prochain canard.{2}": '{0} > You buy a duck detector for {1} xp. A notice will warn you when the next duck takes off.{2}',
    "{0} > Tu achètes un canard mécanique en échange de {1} points d'xp, puis tu le programmes pour décoller dans exactement 10mn.{2}": '{0} > You buy a mechanical duck for {1} xp, then schedule it to take off in exactly 10m.{2}',
    "{0} > Tu achètes un expresso en échange de {1} points d'xp. Ton niveau de fatigue diminue de {2} points.{3}": '{0} > You buy an espresso for {1} xp. Your fatigue drops by {2} points.{3}',
    "{0} > Tu achètes un imperméable en échange de {1} points d'xp. Tu es protégé contre les seaux d'eau pendant 24h.{2}": '{0} > You buy a raincoat for {1} xp. You are protected from buckets of water for 24h.{2}',
    "{0} > Tu offres un verre de gnôle à {1} en échange de {2} points d'xp. Sa fatigue diminue de {3} points, mais sa précision baisse de 10% pendant 1h.{4}": '{0} > You offer {1} a glass of moonshine for {2} xp. Their fatigue drops by {3} points, but their accuracy falls by 10% for 1h.{4}',
    "{0} > Tu offres une infusion de camomille à {1} en échange de {2} points d'xp. Sa fatigue augmente de {3} points pendant 1h.{4}": '{0} > You offer {1} a chamomile infusion for {2} xp. Their fatigue increases by {3} points for 1h.{4}',
    "{0} > Tu achètes un sauf-conduit en échange de {1} points d'xp. Pendant 24h, tu n'encours plus de pénalité ni de confiscation en cas d'accident de chasse.{2}": '{0} > You buy safe conduct for {1} xp. For 24h, hunting accidents cause no penalty or confiscation.{2}',
    "{0} > Tu installes un dispositif de rechargement automatique en échange de {1} points d'xp. Ton arme se recharge automatiquement pendant 24h tant qu'il reste des chargeurs.{2}": '{0} > You install an automatic reloader for {1} xp. Your weapon reloads automatically for 24h while magazines remain.{2}',
    "{0} > Tu accomplis un rituel de purification en échange de {1} points d'xp. {2} malédiction(s) dissipée(s).{3}": '{0} > You perform a purification ritual for {1} xp. {2} curse(s) dispelled.{3}',
    " Les lunettes de soleil de {0} renvoient l'éblouissement.": " {0}'s sunglasses reflect the glare.",
    ' La précision de son prochain tir est réduite de moitié.': ' Their next-shot accuracy is halved.',
    ' La protection de son arme absorbe le sable.': ' Their weapon protection absorbs the sand.',
    " Le risque d'enrayage de son prochain tir est doublé.": ' The jam risk for their next shot is doubled.',
    ' Son imperméable le protège.': ' Their raincoat protects them.',
    ' Sa précision est réduite pendant 1h.': ' Their accuracy is reduced for 1h.',
    'Le dernier canard a été aperçu il y a {0}. Il est toujours là.': 'The last duck was seen {0} ago. It is still there.',
    ", il s'agissait d'un super-canard": ', it was a golden duck',
    ", il s'agissait d'un canard mécanique": ', it was a mechanical duck',
    'Le dernier canard a été aperçu il y a {0}{1}. Il a été abattu par {2}.': 'The last duck was seen {0} ago{1}. It was shot by {2}.',
    "Effrayé par tout ce bruit, il s'est enfui après {0}.": 'Frightened by all that noise, it fled after {0}.',
    "Las d'attendre, il s'est enfui après {0}.": 'Tired of waiting, it fled after {0}.',
    'Le dernier canard a été aperçu il y a {0}{1}. {2}': 'The last duck was seen {0} ago{1}. {2}',
    'un chasseur': 'a hunter',
    'Le super-canard': 'The golden duck',
    'Le canard mécanique': 'The mechanical duck',
    'Le canard': 'The duck',
    "{0} s'échappe. {1}°'`'°-.,_,.-°'`{2}": "{0} escapes. {1}°'`'°-.,_,.-°'`{2}",
    ' Tu deviens chasseur niveau {0} : {1}.': ' You become a level {0} hunter: {1}.',
    ' (dont {0} super-canards)': ' (including {0} golden ducks)',
    '· {0} {1} (dont {2} {3})': '· {0} {1} (including {2} {3})',
    'super-canard': 'golden duck',
    'super-canards': 'golden ducks',
    'le super-canard': 'the golden duck',
    ' [trèfle à 4 feuilles]': ' [four-leaf clover]',
    '{0} > {1}     Tu as eu {2} en {3}, ce qui te fait un total de {4} {5}{6}{7}.{8}     {9}\\_X<{10}   *COUAC*   {11}[{12} xp]{13}{14}{15}{16}{17}{18}{19}': '{0} > {1}     You got {2} in {3}, bringing your total to {4} {5}{6}{7}.{8}     {9}\\_X<{10}   *QUACK*   {11}[{12} xp]{13}{14}{15}{16}{17}{18}{19}',
    '{0} > {1}     Tu as eu le canard mécanique en {2}.     {3}\\_X<{4}   *BZZzZzt*{5}{6}': '{0} > {1}     You got the mechanical duck in {2}.     {3}\\_X<{4}   *BZZzZzt*{5}{6}',
    'une lettre en bois': 'a wooden letter',
    '{0} > En fouillant les buissons autour du canard, tu trouves {1} qui te manquait, ce qui te permet enfin de reconstituer les mots "DUCK HUNT" ! Tu gagnes un lot d\'items aléatoires, un bon d\'achat d\'une valeur de 50 xp et un réapprovisionnement en munitions. Consulte ton inventaire en tapant !inventory pour voir tes gains.{2}': '{0} > Searching the bushes around the duck, you find the missing {1}, finally completing "DUCK HUNT"! You win random items, a 50 xp voucher and an ammunition refill. Use !inventory to see your rewards.{2}',
    '{0} > En fouillant les buissons autour du canard, tu trouves {1}. Reconstitue les mots "DUCK HUNT" pour gagner un lot. Lettres possédées : {2}.{3}': '{0} > Searching the bushes around the duck, you find {1}. Complete "DUCK HUNT" to win a bundle. Letters owned: {2}.{3}',
    "{0} > En fouillant les buissons autour du canard, tu trouves un magazine de chasse. Sa lecture te rapporte {1} points d'xp !{2}{3} {4}[{1} xp]{5}": '{0} > Searching the bushes around the duck, you find a hunting magazine. Reading it awards {1} xp!{2}{3} {4}[{1} xp]{5}',
    "{0} > En fouillant les buissons autour du canard, tu trouves un bon d'achat d'une valeur de {1} points d'xp à valoir dans le shop.{2}": '{0} > Searching the bushes around the duck, you find a {1} xp voucher for the shop.{2}',
    '{0} > En fouillant les buissons autour du canard, tu trouves un parchemin portant le sceau de la CCCCC (Commission de Contrôle des Chasseurs de Canards Confirmés) et comportant la {1} : {2}{3}': '{0} > Searching the bushes around the duck, you find a scroll bearing the CCCCC seal (Commission for the Control of Confirmed Duck Hunters) and containing the {1}: {2}{3}',
    '{0} > En fouillant les buissons autour du canard, tu trouves... une lettre Q en bois. Elle ne semble pas faire partie du jeu.': '{0} > Searching the bushes around the duck, you find... a wooden Q. It does not seem to belong to the game.',
    '{0} > Ton amulette de bénédiction se met à vibrer et disparaît, emportant la malédiction avec elle. {1}[amulette]{2}': '{0} > Your blessing amulet vibrates and vanishes, taking the curse with it. {1}[amulet]{2}',
    "{0} > Tu viens d'abattre ton {1}ème canard, ce qui te fait gagner un bon d'achat d'une valeur de {2} points d'xp à valoir dans le shop !": '{0} > You just shot your {1}th duck, earning a {2} xp voucher for the shop!',
    '{0} > Ton Amulette du Boulanger fait apparaître un morceau de pain sur {1}. {2}[amulette]{3}': "{0} > Your Baker's Amulet makes a piece of bread appear on {1}. {2}[amulet]{3}",
    '{0} > Ton Amulette du Farceur programme un canard mécanique dans 10mn00s. {1}[amulette]{2}': "{0} > Your Prankster's Amulet schedules a mechanical duck in 10m00s. {1}[amulet]{2}",
    '{0} > {1}     Le super-canard a survécu ! Essaie encore.   {2}\\_O<{3}  [vie -{4}]{5}{6}': '{0} > {1}     The golden duck survived! Try again.   {2}\\_O<{3}  [life -{4}]{5}{6}',
    '{0} > {1}     Le canard mécanique a survécu.   {2}\\_O<{3}  [vie -{4}]{5}{6}': '{0} > {1}     The mechanical duck survived.   {2}\\_O<{3}  [life -{4}]{5}{6}',
    '{0} > {1}     Le canard a survécu.   {2}\\_O<{3}  [vie -{4}]{5}{6}': '{0} > {1}     The duck survived.   {2}\\_O<{3}  [life -{4}]{5}{6}',
    '{0} > {1}     Raté. {2}{3}{4}': '{0} > {1}     Missed. {2}{3}{4}',
    '{0} > {1}*CLIC*{2}     CHARGEUR VIDE{3}': '{0} > {1}*CLICK*{2}     EMPTY MAGAZINE{3}',
    '{0} > {1}*Crr..CLIC*{2}     Tu décoinces et recharges ton arme.{3}': '{0} > {1}*Crr..CLICK*{2}     You unjam and reload your weapon.{3}',
    '{0} > Tu es à court de chargeurs.{1}': '{0} > You are out of magazines.{1}',
    "Effrayé par tout ce bruit, le canard s'échappe.     {0}·°'`'°-.,¸¸.·°'`{1}": "Frightened by all that noise, the duck escapes.     {0}·°'`'°-.,¸¸.·°'`{1}",
    "{0} > Tu n'es pas assez riche pour effectuer cet achat.": '{0} > You cannot afford this purchase.',
    '{0} > Tu possèdes déjà cet item.': '{0} > You already own this item.',
    '{0} > Le chargeur de ton arme est déjà plein.': '{0} > Your weapon magazine is already full.',
    '{0} > Ta réserve de chargeurs est déjà pleine.': '{0} > Your magazine reserve is already full.',
    '{0} > Tu as déjà ton arme.': '{0} > You already have your weapon.',
    '{0} > Tes vêtements sont déjà secs.': '{0} > Your clothes are already dry.',
    "{0} > Ton arme n'a pas besoin d'être remise en état.": '{0} > Your weapon does not need restoring.',
    "{0} > Il y a déjà 20 morceaux de pain sur {1}, ça devrait suffire pour l'instant.": '{0} > There are already 20 pieces of bread on {1}; that should be enough for now.',
    "{0} > Tu n'es pas assez fatigué pour utiliser cet objet.": '{0} > You are not tired enough to use this item.',
    "{0} > Tu ne souffres d'aucune malédiction.": '{0} > You are not affected by any curse.',
    'Malédiction de Pesanteur': 'Curse of Burden',
    'tu te fatigues 2 fois plus vite pendant 24h.': 'you tire twice as fast for 24h.',
    'Malédiction de Confusion': 'Curse of Confusion',
    "les canards et les super-canards te rapportent 2 fois moins d'xp pendant 24h.": 'ducks and golden ducks award half as much xp for 24h.',
    'Malédiction de Décadence': 'Curse of Decay',
    "ton arme a pris un sérieux coup de vieux et sa fiabilité est réduite de 33% pendant 24h.": 'your weapon has aged badly and its reliability is reduced by 33% for 24h.',
    'Malédiction de Frénésie': 'Curse of Frenzy',
    "chacun de tes tirs consomme 2 munitions et fait 2 fois plus de dégâts pendant 4h. Ta fatigue augmente aussi plus rapidement.": 'each shot consumes 2 rounds and deals twice the damage for 4h. Your fatigue also rises faster.',
    'Malédiction du Manchot': 'Curse of the One-Armed Hunter',
    "tu es devenu incapable de recharger ton arme mais tu peux encore tirer tant qu'il te reste des munitions chargées. L'effet dure 3h.": 'you cannot reload, but may still shoot while ammunition remains loaded. The effect lasts 3h.',
    'Malédiction de Lenteur': 'Curse of Slowness',
    "chacun de tes tirs et de tes rechargements d'arme seront retardés de 5 secondes pendant 4h.": 'each shot and reload is delayed by 5 seconds for 4h.',
    'Malédiction du Tremblement': 'Curse of Trembling',
    'tu te mets à trembler comme une feuille, ce qui réduit ta précision de 25% pendant 24h.': 'you shake like a leaf, reducing your accuracy by 25% for 24h.',
    "Malédiction de l'Indicible Raté": 'Curse of the Unerring Miss',
    "pendant 4h, chacun de tes tirs touchera obligatoirement quelque chose, et si ce n'est pas un canard...": 'for 4h, every shot will hit something, and if it is not a duck...',
}
